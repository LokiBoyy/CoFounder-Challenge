        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">
              Wunder Kitchen: your kitchen in 10 mins
            </h1>
            <p className="mt-3 text-xl text-muted-foreground">
            Discover the future of kitchen design, where innovation, style, 
            and sustainability come together to create smarter, more efficient spaces.
            </p>
            {/* Buttons */}
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              ...
              <Button size={"lg"} onClick={() => router.push('/dasboard')}>Get started</Button>
            </div>
            {/* End Buttons */}
          ...
          <div className="relative ms-4">
            <img
              ...
              src="https://i.pinimg.com/originals/18/50/7e/18507e602a2e27bbb0abe3d0901e5737.gif"
